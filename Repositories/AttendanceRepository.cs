...
namespace UnicomTICManagementSystem.Repositories
{
    public class AttendanceRepository : IAttendanceRepository
    {
        ...
        public List<Attendance> GetAttendanceByTimetable(int timetableID)
        {
            ...
            {
                string query = @"
                    SELECT a.AttendanceID, a.TimetableID, a.StudentID, s.Name AS StudentName, a.Status, a.MarkedBy, a.MarkedDate
                    FROM Attendance a
        ...
        public List<Attendance> GetFullAttendance()
        {
            ...
            using (var conn = DatabaseManager.GetConnection())
            {
                string query = @"SELECT a.AttendanceID, a.TimetableID, a.StudentID, s.Name AS StudentName,
